...
<body>
    <form method="POST" class="form1">
        ...
        <br>
        Если у вас ещё нет семьи, вы можете создать новую, для этого поставьте галочку<input type="checkbox" name="new_family">
        <br>
        ...
        <br>
        Я соглашаюсь с <a href="agreement.html">пользовательским соглашением</a> <input type="checkbox" name="agreeement">
        <br>
    ...
    <?php
        ...
        if($nf =="")
        {
            echo'<script>alert("Поставьте галочку");</script>';
            return;
        }
